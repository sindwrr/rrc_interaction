...
mkdir build
asn1c -D request_src -pdu=RRCConnectionRequest -no-gen-OER -no-gen-example rrc_connection_request.asn1
asn1c -D setup_src -pdu=RRCConnectionSetup -no-gen-OER -no-gen-example rrc_connection_setup.asn1
asn1c -D setup_complete_src -pdu=RRCConnectionSetupComplete -no-gen-OER -no-gen-example rrc_connection_setup_complete.asn1
